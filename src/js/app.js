...
function render(variables = {}) {
  ...
  let socialMediaBarPosition = `left`;
  if (variables.socialMediaPosition !== left)
    socialMediaBarPosition = variables.socialMediaPosition;
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <h2>${role}</h2>
          <h3>${city}, ${country}</h3>
          <ul class="${socialMediaBarPosition}">
            <li><a target="_blank" href="https://twitter.com/${twitter}"><i class="fab fa-twitter"></i></a></li>
            <li><a target="_blank" href="https://github.com/${github}"><i class="fab fa-github"></i></a></li>
            <li><a target="_blank" href="https://linkedin.com/in/${linkedin}"><i class="fab fa-linkedin"></i></a></li>
            <li><a target="_blank" href="https://instagram.com/${instagram}"><i class="fab fa-instagram"></i></a></li>
          </ul>
        </div>
    `;
}
